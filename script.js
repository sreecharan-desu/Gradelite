    ...
    const subjectsData = {
        'E1': {
            'Sem - 1': {
                ...
                'CIVIL': {
                    names: ["Engineering Chemistry","Differential Equations and Multivariable Calculus","Basic Programming Language","Engineering Graphics and Computer Drafting","Computer Aided Drafting (CAD) Lab","English Language Communication Skills Lab-I","C Programming Lab","",""],
            ...
            'Sem - 2': {
                ...
                'CIVIL': {
                    names: ["Engineering Physics","Mathematical Methods","Basic Electrical and Electronics Engineering","Engineering Mechanics","Engineering Geology","Engineering Physics Lab","Workshop","Environmental Science",""],
        ...
        'E2': {
            'Sem - 1': {
                ...
                'CIVIL': {
                    names: ["Management Economics and Financial Analysis","Building Materials and Construction","Concrete Technology","Mechanics of Fluids","Mechanics of Materials-I","Surveying-I","Mechanics of Materials Lab","Surveying Lab",""],
                    credits: [3,3,3,3,3,3,1.5,1.5,0,0],
                    hide: [9]
                },
                'MECH': {
        ...
        'E3': {
            'Sem - 1': {
                ...
                'CIVIL': {
                    names: ["Advanced Structural Analysis","Design of Reinforced concrete Structures","Environmental Engineering-I","Estimation and Costing","Transportation Engineering-I","English Language Communication Skills Lab-II","Soil Mechanics Lab","Transportation Engineering Lab",""],
                    credits: [4,4,3,3,3,1.5,1.5,1.5,0,0],
                    hide: [9]
                },
                'MECH': {
            ...
            'Sem - 2': {
                ...
                'CIVIL': {
                    names: ["Building Planning and Computer Aided Drawing Lab","Design of Steel Structures","Environmental Engineering-II","Foundation Engineering","Transportation Engineering-II","Professional Elective Course-1/MOOC-1","English Language Communication Skills Lab-1","Environmental Engineering Lab",""],
                    credits: [2.5,4,3,3,3,3,1.5,1.5,0,0],
                    hide: [9]
                },
                'MECH': {
        ...
        'E4': {
            'Sem - 1': {
                ...
                'CIVIL': {
                    names: ["Professional Elective Course-2/MOOC-2","Professional Elective Course-3","Professional Elective Course-4","Open Elective Course-1","Project-1","","","",""],
                    credits: [3,3,3,3,4,0,0,0,0,0],
                    hide: [6,7,8,9]
                },
                'MECH': {
            ...
            'Sem - 2': {
                ...
                'CIVIL': {
                    names: ["Professional Elective Course-5","Open Elective Course-2/MOOC-3s","Open Elective Course-3","Project-2","Indian Community Services","","","",""],
